...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/saqibmir1/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/saqibmir1/SARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to SARBS!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Saqib" 10 60
...
finalize(){ \
	...
	dialog --title "All done!" --msgbox "Congrats! Provided there were no hidden errors, the script completed successfully and all the programs and configuration files should be in place.\\n\\nTo run the new graphical environment, Reboot.\\n\\n.t Saqib" 12 80
	}
...
touch $HOME/.cache/zsh/history >/dev/null 2>%1
